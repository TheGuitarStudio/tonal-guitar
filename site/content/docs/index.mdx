...
| Minor CAGED Scales | 5 | Dm, Cm, Am, Gm, Em shapes |
| CAGED Chords | 5 | E, D, C, A, G shapes (with fingerings and barres) |
| 3NPS | 7 | Patterns 1-7 (one per mode) |
| Pentatonic | 5 | Boxes 1-5 |
| Minor Pentatonic | 5 | Boxes 1-5 Minor |

## Package Sections

- [Fretboard](/docs/fretboard) -- Fretboard math and note lookups
- [Shapes](/docs/shapes) -- Scale and chord shape registry
- [Patterns](/docs/patterns) -- Melodic pattern generators and walker
- [Sequences](/docs/sequences) -- Sequence engine for incremental exercises
- [Output](/docs/output) -- AlphaTeX and ASCII tab formatters
- [Integration](/docs/integration) -- Tonal.js Scale, Chord, Mode, and Key integration
- [Arpeggios & Chord Detection](/docs/arpeggios) -- Arpeggio derivation, shape inference, and voicing data
